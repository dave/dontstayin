...
namespace Js.Blank.MailingUpload
{
		 ...
		 : Js.BlankUserControl.View
	{
		...
		public Element OldPass {get {if (_OldPass == null) {_OldPass = (Element)Document.GetElementById(clientId + "_OldPass");}; return _OldPass;}} private Element _OldPass;
		public jQueryObject OldPassJ {get {if (_OldPassJ == null) {_OldPassJ = jQuery.Select("#" + clientId + "_OldPass");}; return _OldPassJ;}} private jQueryObject _OldPassJ;//mappings.Add("System.Web.UI.WebControls.Label", ElementGetter("Element"));
