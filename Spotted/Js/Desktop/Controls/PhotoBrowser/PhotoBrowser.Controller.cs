...
namespace Js.Controls.PhotoBrowser
{
	public class Controller : PhotoBrowsingUsingKeysControl
	{
		...
		public PhotoProvider PhotoProvider { get { return photoProvider; } set { photoProvider = value; } }
		public Js.Controls.PaginationControl2.Controller PaginationControl { get { return view.uiPaginationControl; } }
		private int selectedIndex;
		public int SelectedIndex { get { return selectedIndex; } set { selectedIndex = value; } }

		public EventHandler OnChangePhoto;
		public EventHandler OnChangePhotoSet;

		public Controller(View view)
			: base(new jQueryObject[] { view.uiPhotoRepeaterContainerJ })
		{
			this.view = view;
			this.iconsPerRow = int.Parse(view.uiIconsPerRow.Value);
			this.iconSize = int.Parse(view.uiIconSize.Value);
			this.iconsPerPage = int.Parse(view.uiIconsPerPage.Value);
			...
			for (int i = 0; i < cells.Length; i++)
			{
				...
				jQuery.FromElement(cells[i].ChildNodes[0]).Click(photoClick);
			}
		...
		public void MoveToNextPhoto(object source, EventArgs e)
		{
		...
		public void MoveToPreviousPhoto(object source, EventArgs e)
		{
			if (!photoSetIsLoadingFromServer)
			{
				SelectedIndex--;
		...
		public void MoveToPhotoAbove(object source, EventArgs e)
		{
		...
		public void MoveToPhotoBelow(object source, EventArgs e)
		{
		...
		public void RolloverMouseOverTextChanged(object o, EventArgs e)
		{
