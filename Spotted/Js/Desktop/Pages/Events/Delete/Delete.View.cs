...
namespace Js.Pages.Events.Delete
{
		 ...
		 : Js.DsiUserControl.View
	{
		...
		public Element EventDescriptionP {get {if (_EventDescriptionP == null) {_EventDescriptionP = (Element)Document.GetElementById(clientId + "_EventDescriptionP");}; return _EventDescriptionP;}} private Element _EventDescriptionP;
		public jQueryObject EventDescriptionPJ {get {if (_EventDescriptionPJ == null) {_EventDescriptionPJ = jQuery.Select("#" + clientId + "_EventDescriptionP");}; return _EventDescriptionPJ;}} private jQueryObject _EventDescriptionPJ;//mappings.Add("System.Web.UI.HtmlControls.HtmlGenericControl", ElementGetter("Element"));
