...
namespace Js.Pages.Galleries.EditOld
{
		 ...
		 : Js.DsiUserControl.View
	{
		...
		public DivElement NotSpotterPanel {get {if (_NotSpotterPanel == null) {_NotSpotterPanel = (DivElement)Document.GetElementById(clientId + "_NotSpotterPanel");}; return _NotSpotterPanel;}} private DivElement _NotSpotterPanel;
		public jQueryObject NotSpotterPanelJ {get {if (_NotSpotterPanelJ == null) {_NotSpotterPanelJ = jQuery.Select("#" + clientId + "_NotSpotterPanel");}; return _NotSpotterPanelJ;}} private jQueryObject _NotSpotterPanelJ;
		public Element H124w2 {get {if (_H124w2 == null) {_H124w2 = (Element)Document.GetElementById(clientId + "_H124w2");}; return _H124w2;}} private Element _H124w2;
		public jQueryObject H124w2J {get {if (_H124w2J == null) {_H124w2J = jQuery.Select("#" + clientId + "_H124w2");}; return _H124w2J;}} private jQueryObject _H124w2J;//mappings.Add("Spotted.CustomControls.h1", ElementGetter("Element"));
		...
		public DivElement PanelNoUpload {get {if (_PanelNoUpload == null) {_PanelNoUpload = (DivElement)Document.GetElementById(clientId + "_PanelNoUpload");}; return _PanelNoUpload;}} private DivElement _PanelNoUpload;
		public jQueryObject PanelNoUploadJ {get {if (_PanelNoUploadJ == null) {_PanelNoUploadJ = jQuery.Select("#" + clientId + "_PanelNoUpload");}; return _PanelNoUploadJ;}} private jQueryObject _PanelNoUploadJ;
		...
		public DivElement JavaPanel {get {if (_JavaPanel == null) {_JavaPanel = (DivElement)Document.GetElementById(clientId + "_JavaPanel");}; return _JavaPanel;}} private DivElement _JavaPanel;
		public jQueryObject JavaPanelJ {get {if (_JavaPanelJ == null) {_JavaPanelJ = jQuery.Select("#" + clientId + "_JavaPanel");}; return _JavaPanelJ;}} private jQueryObject _JavaPanelJ;
