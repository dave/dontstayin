<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BannerPositionAvailability.ascx.cs" Inherits="Spotted.Admin.BannerPositionAvailability" %>
<%@ Register TagPrefix="Controls" TagName="Av" Src="/Controls/Admin/BannerAvailability.ascx" %>
