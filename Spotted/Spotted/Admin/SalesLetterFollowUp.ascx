<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SalesLetterFollowUp.ascx.cs" Inherits="Spotted.Admin.SalesLetterFollowUp" %>
<div class="ContentBorder">
	<p>
		This page shows promoters needing a letter follow-up call. We're not currently sending letters to promoters, so this won't get added to.
	</p>
	<p>
		<asp:DataGrid Runat="server" ID="PromoterDataGrid" 
			...
			<Columns>
				...
				<asp:TemplateColumn HeaderText="Events">
					<ItemTemplate>
						<nobr><%#((Bobs.Promoter)Container.DataItem).FutureEvents%></nobr>
					</ItemTemplate>
				</asp:TemplateColumn>
