<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckBannerBlank.ascx.cs" Inherits="Spotted.Blank.CheckBannerBlank" %>
...
<div class="Content">
	...
	<div class="ContentBorder">
		...
		<h2>
			This page should load in a NEW WINDOW! If this page loaded in the main window, the banner is NOT using the targetTag correctly.
		</h2>
		<p>
