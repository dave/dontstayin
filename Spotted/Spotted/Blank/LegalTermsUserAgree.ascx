<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LegalTermsUserAgree.ascx.cs" Inherits="Spotted.Blank.LegalTermsUserAgree" %>
...
<center>
	<div style="width:500px; padding-top:50px;">
		<div class="WelcomeBox">
			<p>
				We've recently changed our terms and conditions for membership of DontStayIn. 
				We've tried hard to make it easy to read and understand - we've used as little 
				legal jargon as possible! Have a read through - you must agree to them before 
				using the site.
			</p>
		</div>
