...
{
	public partial class EventDisplay2 : EventDisplay
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (Pic.Visible)
			{
				Pic.Src = CurrentEvent.AnyPicPath;
			}
		...
		protected string EventText
		{
			...
			{
				if (baseNamingContainer is Spotted.Controls.EventList)
					return CurrentEvent.ShortDetailsHtmlGeneric(false, 30, false);
				else
					return CurrentEvent.ShortDetailsHtmlGeneric(false, 70, false);
			}
		}
