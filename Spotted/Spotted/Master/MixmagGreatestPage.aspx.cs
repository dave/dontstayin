...
{
	public partial class MixmagGreatestPage : GenericPage
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			Bobs.Log.Increment(Bobs.Log.Items.MixmagGreatestPages);
			if (Bobs.Visit.HasCurrent && !Bobs.Visit.Current.IsCrawler)
				Bobs.Log.Increment(Bobs.Log.Items.MixmagGreatestPagesNoCrawlers);
		...
		public MixmagGreatestUserControl ContentUserControl
		{
			get
			{
				return (MixmagGreatestUserControl)GenericUserControl;
			}
		}
