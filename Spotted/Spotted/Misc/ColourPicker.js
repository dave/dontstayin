...
//	csBrHt=0;
	...
	//{csBrHt=document.body.clientHeight;}ctop=((csBrHt/2)-115)+getScrollY();
...
function getLeft2()
{
	...
	//else if(document.body&&(document.body.clientWidth||document.body.clientHeight)){csBrWt=document.body.clientWidth;}cleft=(csBrWt/2)-125;
