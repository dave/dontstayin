...
Type.registerNamespace('Js.Pages.FindEvents');

////////////////////////////////////////////////////////////////////////////////
// Js.Pages.FindEvents.Controller

Js.Pages.FindEvents.Controller = function Js_Pages_FindEvents_Controller(v) {
    /// <param name="v" type="Js.Pages.FindEvents.View">
    /// </param>
    /// <field name="view" type="Js.Pages.FindEvents.View">
    /// </field>
...
Js.Pages.FindEvents.Controller.prototype = {
    view: null,
    
    _initialise: function Js_Pages_FindEvents_Controller$_initialise() {
    ...
    backLinkClick: function Js_Pages_FindEvents_Controller$backLinkClick(e) {
    ...
    forwardLinkClick: function Js_Pages_FindEvents_Controller$forwardLinkClick(e) {
        /// <param name="e" type="jQueryEvent">
        /// </param>
        e.preventDefault();
        this.view.get_picker().dateModify(7, 'd');
    ...
    _updateDate: function Js_Pages_FindEvents_Controller$_updateDate(newDate) {
    ...
    eventSelectionChange: function Js_Pages_FindEvents_Controller$eventSelectionChange(o, e) {
        ...
        if (!hasBrand && !hasVenue && !(hasMusic && hasPlace)) {
            this.view.get_calendarHolderOuter().style.display = 'none';
            return;
        }
        var specificationState = 'brand-' + ((e.specification.brand == null) ? '0' : e.specification.brand.k.toString()) + '|' + 'place-' + ((e.specification.place == null) ? '0' : e.specification.place.k.toString()) + '|' + 'venue-' + ((e.specification.venue == null) ? '0' : e.specification.venue.k.toString()) + '|' + 'music-' + ((e.specification.music == null) ? '0' : e.specification.music.k.toString()) + '|' + 'date-' + ((e.specification.date == null) ? '0' : e.specification.date.toString());
        if (specificationState !== this._previousSpecificationState) {
            this._previousSpecificationState = specificationState;
            var url = '/support/getuncached.aspx?type=calendar' + '&brandk=' + ((e.specification.brand == null) ? '0' : e.specification.brand.k.toString()) + '&placek=' + ((e.specification.place == null) ? '0' : e.specification.place.k.toString()) + '&venuek=' + ((e.specification.venue == null) ? '0' : e.specification.venue.k.toString()) + '&musictypek=' + ((e.specification.music == null) ? '0' : e.specification.music.k.toString()) + '&date=' + ((e.specification.date == null) ? '0' : e.specification.date.toString());
    ...
    _gotCalendar: function Js_Pages_FindEvents_Controller$_gotCalendar(data, textStatus, req, args) {
    ...
    _debug: function Js_Pages_FindEvents_Controller$_debug(text) {
...
////////////////////////////////////////////////////////////////////////////////
// Js.Pages.FindEvents.View

Js.Pages.FindEvents.View = function Js_Pages_FindEvents_View(clientId) {
    ...
    /// </field>
    /// <field name="_CalendarTabHolder$2" type="Object" domElement="true">
    /// </field>
    /// <field name="_CalendarTabHolderJ$2" type="jQueryObject">
    /// </field>
    /// <field name="_EventFinderTab$2" type="Object" domElement="true">
    /// </field>
    /// <field name="_EventFinderTabJ$2" type="jQueryObject">
    /// </field>
    /// <field name="_MyCalendarTab$2" type="Object" domElement="true">
    /// </field>
    /// <field name="_MyCalendarTabJ$2" type="jQueryObject">
    /// </field>
    /// <field name="_BuddyCalendarTab$2" type="Object" domElement="true">
    /// </field>
    /// <field name="_BuddyCalendarTabJ$2" type="jQueryObject">
    /// </field>
    ...
    /// </field>
    Js.Pages.FindEvents.View.initializeBase(this, [ clientId ]);
    this.clientId = clientId;
}
Js.Pages.FindEvents.View.prototype = {
    clientId: null,
    
    get_newUserWizardOptions: function Js_Pages_FindEvents_View$get_newUserWizardOptions() {
    ...
    get_newUserWizardOptionsJ: function Js_Pages_FindEvents_View$get_newUserWizardOptionsJ() {
    ...
    get_findEventsHeader: function Js_Pages_FindEvents_View$get_findEventsHeader() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_findEventsHeaderJ: function Js_Pages_FindEvents_View$get_findEventsHeaderJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_calendarTabHolder: function Js_Pages_FindEvents_View$get_calendarTabHolder() {
        /// <value type="Object" domElement="true"></value>
        if (this._CalendarTabHolder$2 == null) {
            this._CalendarTabHolder$2 = document.getElementById(this.clientId + '_CalendarTabHolder');
        }
        return this._CalendarTabHolder$2;
    },
    
    _CalendarTabHolder$2: null,
    
    get_calendarTabHolderJ: function Js_Pages_FindEvents_View$get_calendarTabHolderJ() {
        /// <value type="jQueryObject"></value>
        if (this._CalendarTabHolderJ$2 == null) {
            this._CalendarTabHolderJ$2 = $('#' + this.clientId + '_CalendarTabHolder');
        }
        return this._CalendarTabHolderJ$2;
    },
    
    _CalendarTabHolderJ$2: null,
    
    get_eventFinderTab: function Js_Pages_FindEvents_View$get_eventFinderTab() {
        /// <value type="Object" domElement="true"></value>
        if (this._EventFinderTab$2 == null) {
            this._EventFinderTab$2 = document.getElementById(this.clientId + '_EventFinderTab');
        }
        return this._EventFinderTab$2;
    },
    
    _EventFinderTab$2: null,
    
    get_eventFinderTabJ: function Js_Pages_FindEvents_View$get_eventFinderTabJ() {
        /// <value type="jQueryObject"></value>
        if (this._EventFinderTabJ$2 == null) {
            this._EventFinderTabJ$2 = $('#' + this.clientId + '_EventFinderTab');
        }
        return this._EventFinderTabJ$2;
    },
    
    _EventFinderTabJ$2: null,
    
    get_myCalendarTab: function Js_Pages_FindEvents_View$get_myCalendarTab() {
        /// <value type="Object" domElement="true"></value>
        if (this._MyCalendarTab$2 == null) {
            this._MyCalendarTab$2 = document.getElementById(this.clientId + '_MyCalendarTab');
        }
        return this._MyCalendarTab$2;
    },
    
    _MyCalendarTab$2: null,
    
    get_myCalendarTabJ: function Js_Pages_FindEvents_View$get_myCalendarTabJ() {
        /// <value type="jQueryObject"></value>
        if (this._MyCalendarTabJ$2 == null) {
            this._MyCalendarTabJ$2 = $('#' + this.clientId + '_MyCalendarTab');
        }
        return this._MyCalendarTabJ$2;
    },
    
    _MyCalendarTabJ$2: null,
    
    get_buddyCalendarTab: function Js_Pages_FindEvents_View$get_buddyCalendarTab() {
        /// <value type="Object" domElement="true"></value>
        if (this._BuddyCalendarTab$2 == null) {
            this._BuddyCalendarTab$2 = document.getElementById(this.clientId + '_BuddyCalendarTab');
        }
        return this._BuddyCalendarTab$2;
    },
    
    _BuddyCalendarTab$2: null,
    
    get_buddyCalendarTabJ: function Js_Pages_FindEvents_View$get_buddyCalendarTabJ() {
        /// <value type="jQueryObject"></value>
        if (this._BuddyCalendarTabJ$2 == null) {
            this._BuddyCalendarTabJ$2 = $('#' + this.clientId + '_BuddyCalendarTab');
        }
        return this._BuddyCalendarTabJ$2;
    },
    
    _BuddyCalendarTabJ$2: null,
    
    get_topIcon: function Js_Pages_FindEvents_View$get_topIcon() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_topIconJ: function Js_Pages_FindEvents_View$get_topIconJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_debug: function Js_Pages_FindEvents_View$get_debug() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_debugJ: function Js_Pages_FindEvents_View$get_debugJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_picker: function Js_Pages_FindEvents_View$get_picker() {
        /// <value type="Js.Controls.Picker.Controller"></value>
        return eval(this.clientId + '_PickerController');
    },
    
    get_calendarHolderOuter: function Js_Pages_FindEvents_View$get_calendarHolderOuter() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_calendarHolderOuterJ: function Js_Pages_FindEvents_View$get_calendarHolderOuterJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_backLink: function Js_Pages_FindEvents_View$get_backLink() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_backLinkJ: function Js_Pages_FindEvents_View$get_backLinkJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_monthLabel: function Js_Pages_FindEvents_View$get_monthLabel() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_monthLabelJ: function Js_Pages_FindEvents_View$get_monthLabelJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_loadingLabel: function Js_Pages_FindEvents_View$get_loadingLabel() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_loadingLabelJ: function Js_Pages_FindEvents_View$get_loadingLabelJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_forwardLink: function Js_Pages_FindEvents_View$get_forwardLink() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_forwardLinkJ: function Js_Pages_FindEvents_View$get_forwardLinkJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_calendarLoadingOverlay: function Js_Pages_FindEvents_View$get_calendarLoadingOverlay() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_calendarLoadingOverlayJ: function Js_Pages_FindEvents_View$get_calendarLoadingOverlayJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_calendarHolder: function Js_Pages_FindEvents_View$get_calendarHolder() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_calendarHolderJ: function Js_Pages_FindEvents_View$get_calendarHolderJ() {
        /// <value type="jQueryObject"></value>
    ...
    get_genericContainerPage: function Js_Pages_FindEvents_View$get_genericContainerPage() {
        /// <value type="Object" domElement="true"></value>
    ...
    get_genericContainerPageJ: function Js_Pages_FindEvents_View$get_genericContainerPageJ() {
        /// <value type="jQueryObject"></value>
...
Js.Pages.FindEvents.Controller.registerClass('Js.Pages.FindEvents.Controller');
Js.Pages.FindEvents.View.registerClass('Js.Pages.FindEvents.View', Js.DsiUserControl.View);
})(jQuery);
