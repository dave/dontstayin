...
<asp:Panel Runat="server" id="InfoPanel">
	...
	<asp:Panel Runat="server" ID="PhotosPanel">
		...
		<div class="ContentBorder">
			...
			<H2>LOVE PUPPY photos</H2>
			<p>
				Please DELETE all photos uploaded to Love Puppy events. (Love Puppy have requested we do this)
			</p>
			
			<H2>MANUMISSION photos</H2>
			<p>
				Please DELETE all photos uploaded to Manumission events. (Manumission have requested we do this)
			</p>
			
			<H2>Photos uploaded for ARTICLES</H2>
			<p>
				Galleries uploaded for articles have to 
				moderated in the same way as event galleries. Don't worry if they're not 
				clubbing-based - articles can be of anything. Just check these to make sure they 
				aren't pornographic or nasty. You can tell article/event galleries by looking at 
				the gallery list at the top of the page. 
			</p>
		</div>
	</asp:Panel>
