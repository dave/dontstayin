<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyPhotos.ascx.cs" Inherits="Spotted.Pages.Usrs.MyPhotos" %>
...
<asp:Panel Runat="server" ID="PanelPhotos">
	<dsi:UsrIntro runat="server" ID="UsrIntro">
		<p>
			This page shows all photos of <a href="<%= ThisUsr.Url() %>" <%= ThisUsr.Rollover %>><%= ThisUsr.NickName %></a><span runat="server" ID="TakenBySpan"/>.
