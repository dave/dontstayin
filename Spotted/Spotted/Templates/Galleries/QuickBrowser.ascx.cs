...
{
	public partial class QuickBrowser : System.Web.UI.UserControl
	{
		...
		protected string NewHtmlStart
		{
			get
			{
				if (CurrentGallery.IsNew)
				{
					...
					return "<div class=\"NewGalleryBox\" id=\"GalleryDiv" + CurrentGallery.K + "\" style=\"padding-top:3px;\"><div style=\"font-weight:bold;color:#ff0000;margin-bottom:3px;\">" + title + "!</div>";
				}
				return "<div class=\"NewGalleryBoxPadder\" id=\"GalleryDiv" + CurrentGallery.K + "\" style=\"padding-top:3px;\">";
			}
		}
