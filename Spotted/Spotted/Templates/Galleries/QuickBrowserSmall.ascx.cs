...
{
	public partial class QuickBrowserSmall : System.Web.UI.UserControl
	{
		...
		protected string NewHtmlStart
		{
			get
			{
				if (CurrentGallery.IsNew)
					return "<div class=\"NewGalleryBox\" id=\"GalleryDiv" + CurrentGallery.K + "\"><div style=\"height:42px;\">";
				else
					return "<div class=\"NewGalleryBoxPadder\" id=\"GalleryDiv" + CurrentGallery.K + "\"><div style=\"height:42px;\">";
			}
		}
