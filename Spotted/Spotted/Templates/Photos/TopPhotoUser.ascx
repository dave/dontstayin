<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TopPhotoUser.ascx.cs" Inherits="Spotted.Templates.Photos.TopPhotoUser" %>
		...
		<tr>
			<td align="center">
				<div style="width:130px; overflow:hidden;">
					<nobr><%#CurrentPhoto.PhotoOfWeekUserCaption%></nobr>
				</div>
			</td>
		</tr>
	</table>
