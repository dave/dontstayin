...
{
	public partial class TopPhotoUser : System.Web.UI.UserControl
	{
		...
		{
			NormalPanel.Visible = true;// !CurrentPhoto.IsSonyC902;
			SonyPanel.Visible = false;// CurrentPhoto.IsSonyC902;
		}
