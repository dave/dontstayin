<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Large.ascx.cs" Inherits="Spotted.Templates.ThreadUsrs.Large" %>
<table cellspacing="5" cellpadding="0" width="100%">
	<tr>
		<td valign="top" align="right" style="padding-top:1px; padding-right:7px;" rowspan="2">
			<a href="<%#CurrentUsr.Url()%>"><img src="<%#CurrentUsr.AnyPicPath%>" width="100" height="100" class="BorderBlack All" align="top" border="0" <%#CurrentUsr.RolloverNoPic%>></a></td>
