...
{
	public partial class Small : System.Web.UI.UserControl
	{
		...
		{
			OwnerPh.Visible = (CurrentThreadUsr.UsrK == CurrentThreadUsr.InvitingUsrK);
			InvitedPh.Visible = (CurrentThreadUsr.UsrK != CurrentThreadUsr.InvitingUsrK && InvitingUsr != null);
