...
{
	public partial class GroupNewsAdmin : System.Web.UI.UserControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				ForumLink.InnerText = ((IBobType)CurrentThread.ParentForumObject).TypeName + ": " + ((IName)CurrentThread.ParentForumObject).FriendlyName;
