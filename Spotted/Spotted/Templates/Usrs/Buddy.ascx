<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Buddy.ascx.cs" Inherits="Spotted.Templates.Usrs.Buddy" %>
	...
	<tr>
		...
		<td valign="top" style="padding-left:2px;padding-right:10px;" width="100%">
			<small>
				...
				<asp:PlaceHolder Runat="server" ID="RealNamePh">
					- <%#CurrentUsr.FullName%>
				</asp:PlaceHolder>
				<asp:PlaceHolder Runat="server" ID="NotCanInvitePh">
					<br>(can't invite you to chat topics)
				</asp:PlaceHolder>
				<asp:PlaceHolder Runat="server" ID="NotYouCanInvitePh">
