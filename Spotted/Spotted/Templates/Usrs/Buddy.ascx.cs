...
{
	public partial class Buddy : System.Web.UI.UserControl
	{
		protected PlaceHolder RealNamePh, NamePh, EmailPh, NotCanInvitePh, NotYouCanInvitePh;
		...
		public static ColumnSet Columns
		{
			get
			{
				return new ColumnSet(
					...
					Bobs.Buddy.Columns.CanInvite,
					Bobs.Buddy.Columns.FullBuddy,
					Usr.Columns.AddedByUsrK,
					Usr.Columns.Email,
					Usr.Columns.FirstName,
					Usr.Columns.LastName,
					Usr.LinkColumns
				);
			}
		}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			RealNamePh.Visible = CurrentBuddy.FullBuddy;
			NotYouCanInvitePh.Visible = !CurrentBuddy.CanInvite && CurrentBuddy.FullBuddy;
