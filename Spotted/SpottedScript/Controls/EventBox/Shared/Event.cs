...
namespace SpottedScript.Controls.EventBox.Shared
{
	...
	public class EventHtml
	{
		...
		public void AppendHtmlIcon(StringBuilder sb)
		{
			sb.Append(@"<div");
		...
		public void AppendHtmlInfo(StringBuilder sb)
		{
			sb.Append(@"<div");
		...
		public void AppendHtmlInfoInner(StringBuilder sb)
		{
			sb.Append(@"<div");
		...
		public void HideInfoAnimate(string direction)
		{
			...
			InfoHolderInnerJQ.hide("drop", options, 250, new Action(delegate() { Details.Controller.FinishedAnimationTask("HideInfoAnimate"); }));
		}
		#endregion
		#region ShowInfo
		...
		public void ShowInfoAnimate(string direction)
		{
			...
			options["direction"] = direction;
			options["easing"] = "easeOutQuint";
			InfoHolderInnerJQ.show("drop", options, 250, new Action(delegate() { ResizeInfoHolderImmediate(); Details.Controller.FinishedAnimationTask("ShowInfoAnimate"); }));
		...
		public void ResizeInfoHolderAnimate()
		{
			...
			Details.Controller.EventInfoHolderOuterJQ.animate(options, 250, "easeOutQuint", new Action(delegate() { Details.Controller.FinishedAnimationTask("ResizeInfoHolderAnimate"); }));
		}
		public int getInfoHeight()
		{
			int textHeight = InfoTextHolderJQ.Height();
...
#if SCRIPT
		#region Elements
		public DOMElement IconKeylineElement;
		public DOMElement IconImageElement;
		public DOMElement InfoHolderInnerElement;
		public DOMElement InfoTextHolderElement;
		#endregion
		...
		public void kill(DOMElement element)
		{
			if (element == null)
				return;
			...
			bool initialiseInfo)
		{
			if (initialiseIcon)
			{
				...
				jQuery.FromElement(IconImageElement, "mouseover", new DomEventHandler(Details.Controller.EventIconMouseOver));
				jQuery.FromElement(IconImageElement, "mouseout", new DomEventHandler(Details.Controller.EventIconMouseOut));
			}
			...
			{
				InfoHolderInnerElement = Document.GetElementById(InfoHolderInnerClientID);
				InfoHolderInnerJQ = JQueryAPI.JQuery(InfoHolderInnerElement);

				InfoTextHolderElement = Document.GetElementById(InfoTextHolderClientID);
				InfoTextHolderJQ = JQueryAPI.JQuery(InfoTextHolderElement);
			}
