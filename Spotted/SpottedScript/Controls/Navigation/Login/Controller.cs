...
#if MOBILE
namespace MobileScript.Controls.Navigation.Login
#else
namespace SpottedScript.Controls.Navigation.Login
#endif
{
	...
	public class Controller
	{
		...
		Dictionary InitialFacebookAuthResponse = null;
		...
		JQueryObject DetailsPlaceDropDownJ;
		JQueryObject DetailsCountryDropDownJ;
		...
		void initialise()
		{
			JQueryAPI.JQuery(View.ConnectDialog).dialog(
				F.d(
					"autoOpen", false,
					"width", 505,
					"height", 280,
					...
					"draggable", false,
					"closeOnEscape", false,
					"open", new ActionObjectObject(delegate(object ev, object ui) { JQueryAPI.JQuery(".ui-dialog-titlebar-close").hide(); })
				)
			);
		...
		public void Show(ActionBoolBool onExit)
		{
			...
			JQueryAPI.JQuery(View.ConnectDialog).dialog("open");
				...
				new Response(
					delegate(Dictionary response)
					{
						...
						else
						{
							...
							{
								setAuthCookie((Dictionary)U.get(response, "AuthCookie"), (Dictionary)U.get(response, "AuthUsr"));
		...
		DOMElement add_View_Connect_LoggedOutPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_LoggedOut_ConnectButton, "click", new DomEventHandler(connectButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebookButton, "click", new DomEventHandler(noFacebookButtonClick));
		...
		void connectButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void noFacebookButtonClick(DomEvent e)
		{
			e.PreventDefault();
			...
			if (AutoLogin)
			{
				...
				else if (AutoLoginUsrIsFacebookNotConfirmed)
				{
					...
					#region home
					Dictionary home = new Dictionary();
					...
					else
					{
						...
						try
						{
							countryKFromIp = int.ParseInvariant(getStringFromBasePage("CountryKFromIp"));
						}
						catch { }
		...
		DOMElement add_View_Connect_LoggedOut_NoFacebook_ChoosePanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Choose_LoginButton, "click", delegate(DomEvent e) { showNoFacebookLoginPanel("ChoosePanel", ""); });
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Choose_SignupButton, "click", delegate(DomEvent e) { showNoFacebookSignUp1Panel("NoFacebookNewAccount"); });
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Choose_BackButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_LoggedOutPanel", e); });
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Choose_CancelButton, "click", new DomEventHandler(cancelButtonClick));
		...
		DOMElement add_View_Connect_LoggedOut_NoFacebook_LoginPanel()
		{
...
<div id=""{ClientID}Connect_LoggedOut_NoFacebook_LoginPanel"" class=""LoginPanel"" style=""display:none;"">
	...
	<p>
		...
		<button id=""{ClientID}Connect_LoggedOut_NoFacebook_Login_ForgottonPasswordButton"" class=""ui-state-default ui-corner-all Pointer SmallButton"" style=""float:right;"">Forgot your password?</button>
			...
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Login_LoginButton, "click", new DomEventHandler(noFacebookLoginButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Login_BackButton, "click", new DomEventHandler(noFacebookLoginBackClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Login_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Login_NoPasswordButton, "click", delegate(DomEvent e) { ensurePanelGenerated("View.Connect_LoggedOut_NoFacebook_PasswordResetPanel"); View.Connect_LoggedOut_NoFacebook_PasswordReset_Title.InnerHTML = "No password?"; changePanelOnClick("View.Connect_LoggedOut_NoFacebook_PasswordResetPanel", e); });
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_Login_ForgottonPasswordButton, "click", delegate(DomEvent e) { ensurePanelGenerated("View.Connect_LoggedOut_NoFacebook_PasswordResetPanel"); View.Connect_LoggedOut_NoFacebook_PasswordReset_Title.InnerHTML = "Forgot your password?"; changePanelOnClick("View.Connect_LoggedOut_NoFacebook_PasswordResetPanel", e); });
		...
		void noFacebookLoginBackClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void noFacebookLoginButtonClick(DomEvent e)
		{
			e.PreventDefault();
					...
					delegate(Dictionary response)
					{
						...
						else
						{
							...
							else
							{
								...
								{
									showNoFacebookSignUp2Panel("NoFacebookLoginSkeleton", (Dictionary)U.get(response, "Details"));
								}
								else if (U.isTrue(response, "NeedsConfirmation"))
								{
									showDetailsPanel("NoFacebookLoginFacebookNotConfirmed", (Dictionary)U.get(response, "Details"));
								}
		...
		DOMElement add_View_Connect_LoggedOut_NoFacebook_LoginNoPasswordPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_LoginNoPassword_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_LoginNoPassword_TryAgainButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_LoggedOut_NoFacebook_LoginPanel", e); });
		...
		DOMElement add_View_Connect_LoggedOut_NoFacebook_PasswordResetPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_PasswordReset_BackButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_LoggedOut_NoFacebook_LoginPanel", e); });
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_PasswordReset_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_PasswordReset_SendLinkButton, "click", new DomEventHandler(noFacebookNoPasswordSendLinkClick));
		...
		void noFacebookNoPasswordSendLinkClick(DomEvent e)
		{
			e.PreventDefault();
		...
		DOMElement add_View_Connect_LoggedOut_NoFacebook_SignUp1Panel()
		{
...
";
			...
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_SignUp1_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_SignUp1_BackButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_LoggedOut_NoFacebook_ChoosePanel", e); });
			DomEvent.AddHandler(View.Connect_LoggedOut_NoFacebook_SignUp1_SaveButton, "click", new DomEventHandler(noFacebookSignup1SaveClick));
		...
		void noFacebookSignup1BackClick(DomEvent e)
		{
			e.PreventDefault();
...
";
		...
		void noFacebookSignup2BackClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void noFacebookSignup2NameKeyUp(DomEvent e)
		{
			if (
		...
		void noFacebookSignup2NicknameKeyUp(DomEvent e)
		{
		...
		Dictionary getNoFacebookSignupPanelData()
		{
			...
			ret["DateOfBirthYear"] = int.ParseInvariant(View.Connect_LoggedOut_NoFacebook_SignUp2_DateOfBirthYearDropDown.Value);
			ret["DateOfBirthMonth"] = int.ParseInvariant(View.Connect_LoggedOut_NoFacebook_SignUp2_DateOfBirthMonthDropDown.Value);
			ret["DateOfBirthDay"] = int.ParseInvariant(View.Connect_LoggedOut_NoFacebook_SignUp2_DateOfBirthDayDropDown.Value);
		...
		void showNoFacebookSignUp2Panel(string source, Dictionary details)
		{
		...
		DOMElement add_View_Connect_ConnectingPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_Connecting_PopupRetry, "click", new DomEventHandler(connectingRetryPopupClick));
			DomEvent.AddHandler(View.Connect_Connecting_CancelButton, "click", new DomEventHandler(connectingCancelButtonClick));
			DomEvent.AddHandler(View.Connect_Connecting_BackButton, "click", new DomEventHandler(connectingBackButtonClick));
			return View.Connect_ConnectingPanel;
		}
		#region connectingCancelButtonClick
		void connectingCancelButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void connectingRetryPopupClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void connectingBackButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		DOMElement add_View_Connect_NewAccount_NoEmailMatchPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_NewAccount_NoEmailMatch_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_NoEmailMatch_FacebookLogoutButton, "click", new DomEventHandler(logoutOfFacebookButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_NoEmailMatch_BackButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_NewAccount_ConfirmFacebookPanel", e); });
			DomEvent.AddHandler(View.Connect_NewAccount_NoEmailMatch_ChooseAccountButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_NewAccount_ChooseAccountPanel", e); });
			DomEvent.AddHandler(View.Connect_NewAccount_NoEmailMatch_NewAccountButton, "click", new DomEventHandler(newAccountButtonClick));
			return View.Connect_NewAccount_NoEmailMatchPanel;
		}
		#endregion
		#region newAccountButtonClick
		void newAccountButtonClick(DomEvent e)
		{
			e.PreventDefault();
				...
				new Response(
					delegate(Dictionary response)
					{
						...
						else
						{
							...
							{
								showDetailsPanel("NewAccount", (Dictionary)U.get(response, "Details"));
							}
							else
							{
								setAuthCookie((Dictionary)U.get(response, "AuthCookie"), (Dictionary)U.get(response, "AuthUsr"));
		...
		DOMElement add_View_Connect_NewAccount_EmailMatchPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_NewAccount_EmailMatch_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_EmailMatch_FacebookLogoutButton, "click", new DomEventHandler(logoutOfFacebookButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_EmailMatch_BackButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_NewAccount_ConfirmFacebookPanel", e); });
			DomEvent.AddHandler(View.Connect_NewAccount_EmailMatch_ChooseAccountButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_NewAccount_ChooseAccountPanel", e); });
			DomEvent.AddHandler(View.Connect_NewAccount_EmailMatch_AutoConnectButton, "click", new DomEventHandler(autoConnectClick));
			return View.Connect_NewAccount_EmailMatchPanel;
		}
		#endregion
		#region autoConnectClick
		void autoConnectClick(DomEvent e)
		{
			e.PreventDefault();
					...
					delegate(Dictionary response)
					{
						...
						else
						{
							if (U.isTrue(response, "FacebookEmailMatch"))
							{
								if (U.isTrue(response, "NeedsConfirmation"))
								{
									showDetailsPanel("AutoConnect", (Dictionary)U.get(response, "Details"));
								}
								else
								{
									setAuthCookie((Dictionary)U.get(response, "AuthCookie"), (Dictionary)U.get(response, "AuthUsr"));
		...
		DOMElement add_View_Connect_NewAccount_ChooseAccountPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_NewAccount_ChooseAccount_BackButton, "click", new DomEventHandler(chooseAccountBackButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ChooseAccount_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ChooseAccount_FacebookLogoutButton, "click", new DomEventHandler(logoutOfFacebookButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ChooseAccount_LinkAccountButton, "click", new DomEventHandler(linkAccountClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ChooseAccount_ForgottonPasswordButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_NewAccount_ForgotPasswordPanel", e); });
		...
		void linkAccountClick(DomEvent e)
		{
			e.PreventDefault();
					...
					delegate(Dictionary response)
					{
						...
						else
						{
							...
							else
							{
								if (U.isTrue(response, "NeedsConfirmation"))
								{
									showDetailsPanel("LinkAccount", (Dictionary)U.get(response, "Details"));
								}
								else
								{
									setAuthCookie((Dictionary)U.get(response, "AuthCookie"), (Dictionary)U.get(response, "AuthUsr"));
		...
		void chooseAccountBackButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		DOMElement add_View_Connect_NewAccount_ForgotPasswordPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_NewAccount_ForgotPassword_BackButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_NewAccount_ChooseAccountPanel", e); });
			DomEvent.AddHandler(View.Connect_NewAccount_ForgotPassword_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ForgotPassword_FacebookLogoutButton, "click", new DomEventHandler(logoutOfFacebookButtonClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ForgotPassword_SendLinkButton, "click", new DomEventHandler(forgotPasswordSendLinkClick));
		...
		void forgotPasswordSendLinkClick(DomEvent e)
		{
			e.PreventDefault();
		...
		DOMElement add_View_Connect_NewAccount_ConfirmFacebookPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_NewAccount_ConfirmFacebook_BackButton, "click", delegate(DomEvent e) { changePanelOnClick("View.Connect_LoggedOutPanel", e); });
			DomEvent.AddHandler(View.Connect_NewAccount_ConfirmFacebook_YesButton, "click", new DomEventHandler(confirmFacebookAccountYesClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ConfirmFacebook_NoButton, "click", new DomEventHandler(confirmFacebookAccountNoClick));
			DomEvent.AddHandler(View.Connect_NewAccount_ConfirmFacebook_CancelButton, "click", new DomEventHandler(cancelButtonClick));
		...
		void confirmFacebookAccountYesClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void confirmFacebookAccountNoClick(DomEvent e)
		{
			e.PreventDefault();
...
";
		...
		void showDetailsPanel(string source, Dictionary details)
		{
			//debug(source);
			...
			Dictionary homePlace = null;
			if (details != null)
			{
				homePlace = (Dictionary)U.get(details, "HomePlace");
		...
		void detailsCountryDropDownChange(DomEvent e)
		{
			e.PreventDefault();
		...
		void detailsPlaceDropDownChange(DomEvent e)
		{
			e.PreventDefault();
		...
		void detailsPlaceChangeLinkClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void detailsPanelBackClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void detailsPanelSaveClick(DomEvent e)
		{
			e.PreventDefault();
		...
		Dictionary getDetailsPanelData()
		{
			Dictionary detailsPanelData = new Dictionary();

			detailsPanelData["MusicTypeK"] = int.ParseInvariant(((OptionElement)View.Connect_Details_MusicDropDown.Options[View.Connect_Details_MusicDropDown.SelectedIndex]).Value);
		...
		void detailsFacebookInfoAnchorClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void detailsWeeklyEmailInfoAnchorClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void detailsPartyInvitesInfoAnchorClick(DomEvent e)
		{
			e.PreventDefault();
					...
					delegate(Dictionary response)
					{
						...
						else
						{
							if (U.isTrue(response, "FacebookAutoLoginUsrMatch"))
							{
								if (U.isTrue(response, "NeedsConfirmation"))
								{
									showDetailsPanel("AutoLinkByAutoLoginUsr", (Dictionary)U.get(response, "Details"));
								}
								else
								{
									setAuthCookie((Dictionary)U.get(response, "AuthCookie"), (Dictionary)U.get(response, "AuthUsr"));
		...
		DOMElement add_View_Connect_CaptchaPanel()
		{
			#region CaptchaPanel
			string s = @"
...
";
			...
			DomEvent.AddHandler(View.Connect_Captcha_SaveButton, "click", new DomEventHandler(captchaPanelSaveClick));
			DomEvent.AddHandler(View.Connect_Captcha_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_Captcha_BackButton, "click", new DomEventHandler(captchaPanelBackClick));
		...
		void showCaptchaPanel(string captchaPanelSource, Dictionary details)
		{
		...
		void captchaPanelSaveClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void captchaPanelBackClick(DomEvent e)
		{
			e.PreventDefault();
		...
		DOMElement add_View_Connect_LoggedInPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_LoggedIn_DisconnectButton, "click", new DomEventHandler(disconnectButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedIn_LogoutButton, "click", new DomEventHandler(logoutButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedIn_CloseButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedIn_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_LoggedIn_DisconnectButtonShowLink, "click", new DomEventHandler(disconnectButtonShowClick));
		...
		void disconnectButtonShowClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void disconnectButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		DOMElement add_View_Connect_CreatePasswordPanel()
		{
...
<div id=""{ClientID}Connect_CreatePasswordPanel"" class=""LoginPanel"" style=""display:none;"">
	...
	<p>
		...
		<button id=""{ClientID}Connect_CreatePassword_CancelButton"" class=""ui-state-default ui-corner-all Pointer SmallButton"" style=""float:right;"">Cancel</button>
			...
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_CreatePassword_DisconnectButton, "click", new DomEventHandler(createPasswordDisconnectButtonClick));
			DomEvent.AddHandler(View.Connect_CreatePassword_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_CreatePassword_BackButton, "click", new DomEventHandler(createPasswordBackButtonClick));
		...
		void createPasswordBackButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void createPasswordDisconnectButtonClick(DomEvent e)
		{
			e.PreventDefault();
						...
						else
						{
							if (U.isTrue(response, "DoneUnlink"))
							{
								...
								FB.api(
									...
									new Response(
										delegate(Dictionary revokeResponse)
										{
											if (RegisterEndAsync(thisAsyncOperation1))
												return;
		...
		DOMElement add_View_Connect_AutoLoginMismatchPanel()
		{
...
<div id=""{ClientID}Connect_AutoLoginMismatchPanel"" class=""LoginPanel"" style=""display:none;"">
	...
	<p>
		<button id=""{ClientID}Connect_AutoLoginMismatch_CancelButton""  class=""ui-state-default ui-corner-all Pointer SmallButton"" style=""float:right;"">Cancel</button>		
			...
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_AutoLoginMismatch_RetryButton, "click", new DomEventHandler(detectAutoLoginRetryClick));
			DomEvent.AddHandler(View.Connect_AutoLoginMismatch_ContinueButton, "click", new DomEventHandler(detectAutoLoginContinueClick));
			DomEvent.AddHandler(View.Connect_AutoLoginMismatch_CancelButton, "click", new DomEventHandler(detectAutoLoginRetryClick));
			DomEvent.AddHandler(View.Connect_AutoLoginMismatch_SwitchButton, "click", new DomEventHandler(detectAutoLoginSwitchClick));
			DomEvent.AddHandler(View.Connect_AutoLoginMismatch_SwitchAccountsShowLink, "click", new DomEventHandler(detectAutoLoginSwitchShowLinkClick));
		...
		void detectAutoLoginContinueClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void detectAutoLoginRetryClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void detectAutoLoginSwitchShowLinkClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void detectAutoLoginSwitchClick(DomEvent e)
		{
			e.PreventDefault();
				...
				new Response(
					delegate(Dictionary response)
					{
						...
						else
						{
							if (U.isTrue(response, "NeedsConfirmation"))
							{
								showDetailsPanel("SwitchAccounts", (Dictionary)U.get(response, "Details"));
							}
							else
							{
								setAuthCookie((Dictionary)U.get(response, "AuthCookie"), (Dictionary)U.get(response, "AuthUsr"));
		...
		DOMElement add_View_Connect_LikeButtonPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_LikeButton_CancelButton, "click", new DomEventHandler(cancelButtonClick));
		...
		DOMElement add_View_Connect_LoadingPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_Loading_CancelButton, "click", new DomEventHandler(cancelButtonClick));
		...
		DOMElement add_View_Connect_ErrorPanel()
		{
...
";
			addChild(s);
			#endregion
			DomEvent.AddHandler(View.Connect_Error_CancelButton, "click", new DomEventHandler(cancelButtonClick));
			DomEvent.AddHandler(View.Connect_Error_TryAgainButton, "click", new DomEventHandler(errorTryAgainClick));
		...
		void errorTryAgainClick(DomEvent e)
		{
			e.PreventDefault();
		...
		DOMElement add_View_Connect_LoadingLabel()
		{
...
";
					...
					new Callback(
						delegate()
						{
							if (AsyncInProgress && thisAsyncOperationCounter == AsyncOperationCounter)
							{
								...
								DomEvent.AddHandler(
									Document.GetElementById("Connect_LoadingLabel_CancelLink"),
									"click",
									new DomEventHandler(
										delegate(DomEvent e)
										{
		...
		DOMElement add_View_Connect_DebugPanel()
		{
...
";
			...
			#endregion
			DomEvent.AddHandler(View.Connect_Debug_LogoutButton, "click", new DomEventHandler(logoutButtonClick));
			DomEvent.AddHandler(View.Connect_Debug_DisconnectButton, "click", new DomEventHandler(disconnectDebug));
			return View.Connect_DebugPanel;
		}
		#endregion
		#region disconnectDebug
		void disconnectDebug(DomEvent e)
		{
			e.PreventDefault();
		...
		void setAuthCookie(Dictionary authCookie, Dictionary authUsr)
		{
			string name = U.get(authCookie, "Name").ToString();
			string value = U.get(authCookie, "Value").ToString();
			string expires = ((DateTime)U.get(authCookie, "Expires")).ToUTCString();
		...
		void cancelButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void logoutButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		void logoutOfFacebookButtonClick(DomEvent e)
		{
			e.PreventDefault();
		...
		#region changePanel
		void changePanelOnClick(string panelString, DomEvent e)
		{
			e.PreventDefault();
		...
		{
			DOMElement panel = getPanel(panelString);
		...
		#endregion
		#region getPanel
		DOMElement getPanel(string panelString)
		{
		...
		DOMElement ensurePanelGenerated(string panelString)
		{
			DOMElement panel = getPanel(panelString);
		...
		{
			return s.Replace(clientIdRegex, View.clientId + "_");
		}
		...
		int getIntFromPage(string id)
		{
			...
			try
			{
				i = int.ParseInvariant(((InputElement)Document.GetElementById("Content_" + id)).Value);
			}
			catch { }
			return i;
		}
