...
namespace SpottedScript.Pages.Usrs.FavouritePhotos
{
	public class Controller : PhotosController
	{
		...
		{
			get { return photoProvider ?? (photoProvider = new FavouritePhotosOfUsrProvider(int.ParseInvariant(view.uiUsrK.Value))); }
		}
