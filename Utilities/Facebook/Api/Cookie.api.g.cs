...
namespace Facebook.Api {
    ...
    [FacebookObjectAttribute("cookie")]
    public class Cookie : Facebook.Api.FacebookObjectBase {
        
        /// <summary>Intializes an instance of <see cref="Cookie" /> using the specified xml document or snippet as the data source.</summary>
        /// <param name="content">An <see cref="XElement" /> object containing xml data for the object.</param>
        public Cookie(System.Xml.Linq.XElement content) : 
                base(content) {
        }
        
        /// <summary>Intializes an instance of <see cref="Cookie" />, prefilling the internal dictionary with the specified values.</summary>
        /// <param name="dict">An <see cref="IDictionary{String, Object}" /> object containing property names and values.</param>
        public Cookie(System.Collections.Generic.IDictionary<string, object> dict) : 
                base(dict) {
        }
        
        /// <summary>Intializes an instance of <see cref="Cookie" />.</summary>
        public Cookie() {
        }
        ...
        public String Path {
            ...
            set {
                this.InnerDictionary["path"] = value;
            }
        }
    }
}
