...
namespace Facebook.Api {
    ...
    public class FullStoryTemplate : Facebook.Api.FacebookObjectBase {
        
        /// <summary>Intializes an instance of <see cref="FullStoryTemplate" /> using the specified xml document or snippet as the data source.</summary>
        /// <param name="content">An <see cref="XElement" /> object containing xml data for the object.</param>
        public FullStoryTemplate(System.Xml.Linq.XElement content) : 
                base(content) {
        }
        
        /// <summary>Intializes an instance of <see cref="FullStoryTemplate" />, prefilling the internal dictionary with the specified values.</summary>
        /// <param name="dict">An <see cref="IDictionary{String, Object}" /> object containing property names and values.</param>
        public FullStoryTemplate(System.Collections.Generic.IDictionary<string, object> dict) : 
                base(dict) {
        }
        
        /// <summary>Intializes an instance of <see cref="FullStoryTemplate" />.</summary>
