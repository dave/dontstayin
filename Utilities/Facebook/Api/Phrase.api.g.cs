...
namespace Facebook.Api {
    ...
    [FacebookObjectAttribute("phrase")]
    public class Phrase : Facebook.Api.FacebookObjectBase {
        
        /// <summary>Intializes an instance of <see cref="Phrase" /> using the specified xml document or snippet as the data source.</summary>
        /// <param name="content">An <see cref="XElement" /> object containing xml data for the object.</param>
        public Phrase(System.Xml.Linq.XElement content) : 
                base(content) {
        }
        
        /// <summary>Intializes an instance of <see cref="Phrase" />, prefilling the internal dictionary with the specified values.</summary>
        /// <param name="dict">An <see cref="IDictionary{String, Object}" /> object containing property names and values.</param>
        public Phrase(System.Collections.Generic.IDictionary<string, object> dict) : 
                base(dict) {
        }
        
        /// <summary>Intializes an instance of <see cref="Phrase" />.</summary>
        public Phrase() {
        }
